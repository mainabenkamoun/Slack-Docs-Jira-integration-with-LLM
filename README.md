...
- New Jira tiket creation, triggered by the emoji :jira-new: an LLM (Claude sonnet) creates a JIRA ticket with enriched description and summary, and posts via a slack bot the created JIRA issue
